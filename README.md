...
- `GET /liga/confrontos` — quem enfrenta quem na rodada atual, com placar se já tiver rolado
...
- `GET /noticias?time_nfl=KC` — últimas notícias da NFL (fonte: ESPN), com foto, resumo e link
